...
{
    public static Dictionary<int, StorageLimitDictionary> ThingLimitsByZone =  new();
    
    public static Dictionary<int, StorageLimitDictionary> ThingLimitsByZoneCopy =  new();
